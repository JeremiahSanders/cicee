...
{
  public static async Task<Result<InitRequest>> TryHandleAsync(CommandDependencies dependencies, string projectRoot, string? image, bool force)
  {
  ...
  public static async Task<int> HandleAsync(CommandDependencies dependencies, string projectRoot, string? image, bool force)
  {
