...
public static class TemplateInitEntrypoint
{
  ...
  public static async Task<Result<TemplateInitResult>> TryHandleAsync(ICommandDependencies dependencies,
  ...
  public static async Task<int> HandleAsync(ICommandDependencies dependencies, string projectRoot, bool force)
  {
