...
{
  public static Result<TemplateInitContext> ValidateRequestExecution(
    ...
    TemplateInitRequest request)
  {
    return dependencies
      ...
      .Map(
        ...
        {
          (string metadataFilePath, ProjectMetadata projectMetadata) = ProjectMetadataLoader
            ...
            .IfFail(
              _ => (
                FilePath: dependencies.CombinePath(validatedProjectRoot, ProjectMetadataLoader.DefaultMetadataFileName),
