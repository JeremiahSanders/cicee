...
public static class ProjectMetadataLoader
{
  ...
  public static readonly IReadOnlyList<string> RelativeProjectMetadataNames = new[]
  {
  ...
  public static string CreateDefaultMetadataFileName(Func<string, string, string> combinePath, string projectRoot)
  {
    ...
    string projectRoot)
  {
    return ensureDirectoryExists(projectRoot)
      .Bind(_ => RelativeProjectMetadataNames.Fold(
          ...
          (lastResult, filePath) => lastResult.BindFailure(_ =>
    ...
    Func<Result<string>> tryGetCurrentDirectory)
  {
    return tryGetCurrentDirectory()
      .Bind(initialDirectory => TryInferProjectMetadataFromDirectories(
    ...
    return TryFindProjectMetadata(
      ...
      .Match(
        ...
        _ => tryGetParentDirectory(initialDirectory)
          ...
          .Bind(parentDirectory => TryInferProjectMetadataFromDirectories(
              ensureDirectoryExists,
              ensureFileExists,
              tryLoadFileString,
              combinePath,
    ...
    string filePath)
  {
    return ensureFileExists(filePath)
      .Bind(validatedFile => tryLoadFileString(validatedFile)
        .MapFailure(loadingFailure => BadRequestException.FromException(
      ...
      .Bind(content => Json
        ...
        .MapFailure(deserializationFailure => BadRequestException.FromException(
